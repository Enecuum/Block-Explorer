            ...
            <b-container fluid class="container-wrapper">
              ...
              <b-row class="m-0 mb-20 pb-20 border-bottom-gray">
                ...
                <b-col class="d-flex align-items-center justify-content-center pl-0 pr-0">
                  <svg class="mr-2" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="30px" height="39px" version="1.1" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd"  viewBox="0 0 1325288 1672151">
                   <g>
                    <g>
              ...
              <b-row class="text-center mt-10 mb-10">
                ...
                <b-col class="text-center">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <button v-clipboard:copy="$route.params.id" class="copy">{{ $t('explorer.microblock.copy') }}</button>
                  </div>
                </b-col>
              ...
              <b-row class="no-gutters border-bottom-gray border-top-gray">
                <b-col cols="12" sm="5" class="text-left border-bottom-gray-xs">
                  ...
                  <b-row class="py-1  no-gutters">
                    <b-col class="weight-600 gray-text">{{ $t('explorer.microblock.block') }}:</b-col>
                    <b-col class="weight-600 hash-wrapper">
                      <router-link class="href" :to="{name: 'Block', params: {id: K_hash }}">{{ K_hash }}</router-link>
                    </b-col>
                  </b-row>
                ...
                <b-col cols="12" sm="5" offset-sm="2" class="text-left">
                  ...
                  <b-row class="py-1 no-gutters">
                    <b-col class="weight-600 gray-text">{{ $t('explorer.microblock.publisher') }}:</b-col>
                    <b-col class="weight-600 hash-wrapper">
              ...
              <b-row class="no-gutters border-bottom-gray">
                <b-col cols="12" sm="5" class="text-left">
                  ...
                  <b-row class="py-1 no-gutters">
                    <b-col class="weight-600 gray-text">{{ $t('explorer.microblock.attached') }}:</b-col>
              ...
              <template v-if="total">
                ...
                <b-row class="mt-20 mx-0 pb-20 border-bottom-gray">
                  <b-col class="d-flex align-items-center justify-content-center">
                    <svg class="mr-2" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="17px"
                         height="20px" version="1.1" shape-rendering="geometricPrecision"
                         text-rendering="geometricPrecision" image-rendering="optimizeQuality"
                         fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 523950 603031">
                     <g>
                    ...
                    <h4 class="m-0 weight-600">
                      {{ $t('explorer.microblock.transactions') }}
                    </h4>
                  </b-col>
                </b-row>
                        ...
                        <b-button-toolbar key-nav class="mt-10 justify-content-center">
                          ...
                          <b-button-group class="pagination-group border-right-0">
                            ...
                            <b-btn @click="fetchData(++currentPage)"
                                   :disabled="this.last" class="pagination-button border-left-0 weight-600">prev
                              &rsaquo;
                            </b-btn>
                          </b-button-group>
  ...
  export default {
    ...
    data() {
      return {
        ...
        Tx: [],
        fields: [
          {key: 'hash', label: this.$i18n.t('explorer.microblock.hash'), tdClass: 'weight-600'},
          {key: 'owner', label: this.$i18n.t('explorer.microblock.from'), tdClass: 'weight-600'},
          {key: 'receiver', label: this.$i18n.t('explorer.microblock.to'), tdClass: 'weight-600'},
          {key: 'amount', label: this.$i18n.t('explorer.microblock.amount'), tdClass: 'weight-600'}
        ],
        preload: true
      }
    },
