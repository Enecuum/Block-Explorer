            ...
            <b-container fluid class="container-wrapper">
              ...
              <b-row class="m-0 mb-20 pb-20 border-bottom-gray">
                ...
                <b-col class="d-flex pr-0 pl-0 align-items-center justify-content-center">
                  <svg class="mr-2" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="30px" height="39px"
              ...
              <b-row class="text-center mt-10 mb-10">
                ...
                <b-col class="text-center">
                  <p class="m-0 font-14 weight-600">
                    {{ $t('explorer.block.hash') }}:
                  </p>
                  <div class="d-flex align-items-center">
                    <router-link :to="{ name: 'Block', params: {id: prevBlock}}"
                                 class="mr-2 copy text-nowrap">
                      &lsaquo; {{ $t('explorer.block.prev') }}
                    </router-link>
                    <div class="hash-wrapper weight-600">
                      {{ $route.params.id }}
                    </div>
                    <button v-clipboard:copy="$route.params.id" class="copy">{{ $t('explorer.block.copy') }}</button>
                  </div>
                </b-col>
              ...
              <b-row class="no-gutters border-bottom-gray border-top-gray">
                ...
                <b-col cols="12" sm="5" class="text-left border-bottom-gray-xs">
                  ...
                  <b-row class="py-1  no-gutters">
                    <b-col class="weight-600 gray-text">{{ $t('explorer.block.height') }}:</b-col>
                ...
                <b-col cols="12" sm="5" offset-sm="2" class="text-left ">
                  ...
                  <b-row class="py-1 no-gutters">
                    <b-col class="weight-600 gray-text">{{ $t('explorer.block.time') }}:</b-col>
                    <b-col class="weight-600">{{ time | moment("YYYY-MM-DD HH:mm:ss") }}</b-col>
                  </b-row>
              ...
              <b-row class="no-gutters border-bottom-gray">
                ...
                <b-col cols="12" sm="5" class="text-left border-bottom-gray-xs">
                  <b-row class="py-1 no-gutters">
                    <b-col class="weight-600 gray-text">{{ $t('explorer.block.nonce') }}:</b-col>
                ...
                <b-col cols="12" sm="5" offset-sm="2" class="text-left">
                  <b-row class="py-1 no-gutters">
                    <b-col class="weight-600 gray-text">{{ $t('explorer.block.solver') }}:</b-col>
              ...
              <b-row class="no-gutters border-bottom-gray">
                <b-col cols="12" sm="5" class="text-left">
                  ...
                  <b-row class="py-1 no-gutters">
                    <b-col class="weight-600 gray-text">{{ $t('explorer.block.attached') }}:</b-col>
                ...
                <b-col cols="12" sm="5" offset-sm="2" class="text-left">
                  ...
                  <b-row class="py-1 no-gutters">
                    <b-col class="weight-600 gray-text">{{ $t('explorer.block.type') }}:</b-col>
              ...
              <template v-if="microblocks.length">
                ...
                <b-row class="mt-20 mx-0 pb-20 border-bottom-gray">
                  <b-col class="d-flex align-items-center justify-content-center">
                    <svg class="mr-2" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="21px"
                         height="25px" version="1.1" shape-rendering="geometricPrecision"
                         text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd"
                         clip-rule="evenodd" viewBox="0 0 1237358 1418840">
                         <g>
  ...
  export default {
    ...
    data() {
      return {
        ...
        microblocks: [],
        fields: [
          {key: 'hash', label: this.$i18n.t('explorer.block.hash'), tdClass: 'weight-600'},
          {key: 'publisher', label: this.$i18n.t('explorer.block.publisher'), tdClass: 'weight-600'},
          {key: 'Tx', label: this.$i18n.t('explorer.block.amount')}
        ],
        preload: true
      }
    },
